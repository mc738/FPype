...
module JsonSerialization =
    ...
    type RegressionTrainerSettingsConverter<'T when 'T :> IRegressionTrainerSettings>() =
    ...
    type MulticlassClassificationTrainerSettingsConverter<'T when 'T :> IMulticlassTrainerSettings>() =
